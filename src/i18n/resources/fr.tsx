...
export const translations: Translations<"fr"> = {
  ...
  SurveyHomepage: {
    ...
    "side menu title": "Menu latéral pour accéder aux informations de l'enquêtes",
    "survey link": "Voir l'enquête en détail",
  ...
  SurveyTable: {
    ...
    "survey unit": "Unité enquêtée",
    "identification name": "Raison sociale",
    "sort": "tri par raison sociale",
    "questionings": "Questionnaires",
    "status": "Statut",
    "action": "Action",
    "go to survey": "Répondre",
    "download deposit proof": "Preuve de dépot",
    "RECEIVED": "TERMINÉ - RECU",
    "NOT_RECEIVED": "TERMINÉ - NON RECU",
    "INCOMING": "À VENIR",
    "OPEN": "EN COURS",
    "pagination label": "Résultats de recherche, page :",
    "downloadLabel": "preuve-de-depot",
  },
  MyAccount: {
