...
export const translations: Translations<"en"> = {
  ...
  SurveyHomepage: {
    ...
    "side menu title": "Side menu to access survey information",
    "survey link": "See the survey in detail",
  ...
  SurveyTable: {
    "respond to the survey": "Respond to survey",
    "survey unit": "Survey unit",
    "identification name": "Company name",
    "sort": "sort by company name",
    "questionings": "Questionings",
    "status": "Status",
    "action": "Action",
    "go to survey": "Reply",
    "download deposit proof": "Proof of deposit",
    "RECEIVED": "FINISHED - RECEIVED",
    "NOT_RECEIVED": "FINISHED - NOT RECEIVED",
    "INCOMING": "INCOMING",
    "OPEN": "OPEN",
    "pagination label": "Search results, page :",
    "downloadLabel": "deposit-proof",
  },
  MyAccount: {
  ...
  HomePage: {
    "portal title": "Welcome to the response portal for public statistics surveys",
    "portal description":
    ...
    "activities title": "The activities of public statistics",
    ...
    "activities analyze": "Analyze",
    "activities diffuse": "Diffuse",
    "confidentiality title": "Insee is bound by statistical confidentiality",
